...
public class Costumer {
	...
	public void setBirthDate(/*DatePicker birthDate*/) {
		//Usar la App de calendario LGoodDatePicker para escojer la fecha y usarla aqui para extraer la fecha
		String birth = "";
		/* 
		 * Con metodos propios de la libreria se extraen los espacios de la fecha, se guardan en enteros
		 * y posteriormente en un string que se guarda en el set de fecha de nacimiento del cliente
	 ...
	 * no sea una letra ("Error2"). Lo anterior invalidara el espacio de entrada del usuario lanzando
	 * el tipo de Error. De lo contrario lanzara un String que dice "Valido".
	 * @return 
	 * Valido, Error 1 o Error 2. Dependiendo de la validacion resultante de la cadena.
	 **/
	 ...
	 * @return 
	 * Valido, Error 1 o Error 3. Dependiendo de la validacion resultante de la cadena.
	 **/
	 ...
	 * Obtener Edad
	 * @apiNote
	 * Este metodo toma el objeto fecha dado por la libreria LGoodDatePicker
	 * lo convierte y formatea en un objeto LocalDate y posteriormente
	 * calcula la cantidad de años (edad) entre la fecha ingresada y la fecha 
	 * actual
	 * 
	 **/
	private int age(String birthDateIn) {
		...
		/*System.out.printf("%s %d %s %d %s %d %s\n",
				"Tengo", age.getYears(),"años,",age.getMonths(),"meses,",age.getDays(),"días");*/
	}
