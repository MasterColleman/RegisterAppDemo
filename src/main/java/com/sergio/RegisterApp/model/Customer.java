...
public class Customer {
     ...
     *
     * @param firstOrLastName Cadena que puede ser nombre o apellido (completos).
     * @return Valido, Error 1 o Error 2. Dependiendo de la validacion resultante de
     * la cadena.
     * @apiNote Aqui se comprueba si el nombre o apellido son nulos (solo uno
     ...
     * @return Valido, Error 1 o Error 3. Dependiendo de la validacion resultante de
     * la cadena.
     * @apiNote Aqui se comprueba si numero de documento es valido:
     ...
     * Obtener Edad
     *
     * @param birthDateIn Fecha de nacimiento entrante de tipo String
     * @return Age
     * Edad de la persona en años
     * @apiNote Este metodo toma la fecha de nacimiento del cliente en String
    ...
    public String validateLegalAge() {
        ...
        if (this.getAge(getBirthDate()) < 18 ) {
            legalAge = "Invalida";
        }else if (this.getAge(getBirthDate()) > 150)
            legalAge = "Imposible";
