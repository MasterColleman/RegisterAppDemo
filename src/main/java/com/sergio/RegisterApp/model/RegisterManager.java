...
public class RegisterManager {
	 ...
	 * @apiNote
	 * Se verifica si el cliente es nulo, si lo es lanza la excepcion CostumerNotFoundException.
	 * Si no es nulo, procede a la siguiente validacion a traves del metodo validarID donde: si el 
	 * cliente no existe en la lista, lo agrega; si el cliente ya existe, lanza la excepcion
	 ...
	 * @apiNote
	 * Se valida tanto tipo de ID como numero de ID para saber si existe o no;
	 ...
	 * Retorna (-2) si el cliente no existe y lanza la excepcion CostumerNotFoundException.
	 ...
	 * de lo contrario lanza la excepcion CostumerNotFoundException o la excepcion ListCostumersNotFoundException.
	 * @param firstOrLastName
	 * Nombre o Apellido Completo del cliente.
	 * @return
	 ...
	 * ListCostumersNotFoundException*/ {                  //Tengo dudas aqui
	 ...
	 */
	public void removeCostumer(String docNumber, DocType docType) /*throws CostumerNotFoundException, ListCostumersNotFoundException*/{ 
		/*Dado que el ID respecto al tipo de ID es el unico que no se repite en toda la lista, este es el que se
	 ...
	 * @param birthDate
	 * @apiNote
	 * Este metodo recibe un cliente de tipo Costumer (existente en la lista) y le setea nuevamente todos los atributos al objeto, para actualizarlo.
	 */
	public void updateClient(Costumer costumer, String firstNames, String lastNames, DocType docType, String docNumber, String birthDate)/*throws CostumerNotFoundException, 
	 ...
	 * @apiNote 
	 * Este metodo solo se usa para filtrar la lista de clientes con palabras clave, para tener como resultado una lista mas
	 * pequeña que solo posea los resultados que contienen plabras clave (como el inicio de un nombre o apellido, o el inicio
